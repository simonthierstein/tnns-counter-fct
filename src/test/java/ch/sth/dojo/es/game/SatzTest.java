...
class SatzTest {
    ...
    void handleCommand_create4_2_Event_isright() {
        final Either<DomainError, DomainEvent> actual = Satz.handleCommand(Satz.zero(), create4_2_Event());
    ...
    void handleCommand_create2_4_Event_isright() {
        final Either<DomainError, DomainEvent> actual = Satz.handleCommand(Satz.zero(), create2_4_Event());
    ...
    void handleCommand_spielerSatzGewonnen_Event_isright() {
        ...
        final Either<DomainError, DomainEvent> actual = Satz.handleCommand(state, create4_2_Event());
        assertThat(actual.get()).isInstanceOf(SpielerHatSatzGewonnen.class);

        final Either<DomainError, Satz> satzs = Satz.handleEvent(state, actual.get());
    ...
    void handleCommand_gegnerSatzGewonnen_Event_isright() {
        ...
        final Either<DomainError, DomainEvent> actual = Satz.handleCommand(state, create2_4_Event());
