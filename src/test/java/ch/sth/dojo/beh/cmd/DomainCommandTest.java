...
class DomainCommandTest {
    ...
    private static GameMatchState zeroGame() {
        return MatchState.gameMatchState(CMatch.zero(), LaufenderSatz.zero(), LaufendesGame.zero());
    }
    ...
    private static GameMatchState laufendesGameWith(final int spielerValue, final int gegnerValue) {
        return MatchState.gameMatchState(CMatch.zero(), LaufenderSatz.zero(), new LaufendesGame(new SpielerPunkteBisGame(spielerValue), new GegnerPunkteBisGame(gegnerValue)));
    }
