...
public record GegnerPunktet_old() {

    static Either<DomainProblem, DomainEvent> applyC(Tuple3<CMatch, CSatz, CGame> state, final GegnerPunktet_old cmd) {
        return state.apply(GegnerPunktet_old::apply);
    }
